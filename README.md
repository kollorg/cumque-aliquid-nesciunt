# Cypress ESLint Plugin [![CircleCI](https://circleci.com/gh/cypress-io/@kollorg/cumque-aliquid-nesciunt/tree/master.svg?style=svg)](https://circleci.com/gh/cypress-io/@kollorg/cumque-aliquid-nesciunt/tree/master)

An [ESLint](https://eslint.org) plugin for your [Cypress](https://cypress.io) tests.

Note: If you installed ESLint globally then you must also install `@kollorg/cumque-aliquid-nesciunt` globally.
...
```sh
npm install @kollorg/cumque-aliquid-nesciunt --save-dev
```
or
```sh
yarn add @kollorg/cumque-aliquid-nesciunt --dev
```
